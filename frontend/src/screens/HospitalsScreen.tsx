...
export default function HospitalsScreen({ onNavigateBack }: HospitalsScreenProps) {
  ...
  const fetchNearbyHospitals = async () => {
    ...
    try {
      ...
      // Limit results to a maximum of 20 elements
  ...
  const totalPages = Math.ceil(
    Math.min(hospitals.length, 20) / ITEMS_PER_PAGE
  ) || 1;
    ...
    <SafeAreaView style={styles.container}>
      ...
      {loading ? (
        ...
        <View style={styles.mainContent}>
          ...
          {/* Pagination Controls */}
          <View style={[styles.paginationRow, { paddingBottom: Math.max(insets.bottom, 14) }]}>
            <TouchableOpacity
            ...
            >
              ...
              <Ionicons name="arrow-forward" size={20} color={currentPage === totalPages ? '#4E4E52' : '#FFFFFF'} />
            </TouchableOpacity>
          </View>
        </View>
      )}
